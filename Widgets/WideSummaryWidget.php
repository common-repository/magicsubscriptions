...
class WideSummaryWidget extends WP_Widget
{
	...
	{
		function_log();
		WideSummaryWidget::$summaryComponent = $summaryComponent;
	}
	...
	function __construct()
	{
		function_log();
		parent::__construct(
			'magicsubscriptions-widesummary',
			'Magic Subs (Wide Summary)',
			array( 'description' => 'Magic Subscriptions Wide Summary' )
		);
	}
	...
	public function widget( $args, $instance )
	{
		...
		echo WideSummaryWidget::$summaryComponent->RenderWide();
